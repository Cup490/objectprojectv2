    ...
    while (answer != 0) {
        switch (answer) {
            ...
            case 1:
                ...
                while (myCollege.findLecturerByName(inputName) != null) {
                ...
                while (myCollege.findLecturerById(inputId) != null) {
            ...
            case 8:
                ...
                System.out.printf("The average salary of all lecturers is:", globalAverage);
                break;
            case 9:
                System.out.print("Enter the Department Name: ");
            ...
            default:
                System.out.println("you chose the an option that does not exist");
        }
        System.out.println(choices);
        answer = s.nextInt();
    }
